...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/database/";
...
// 
    	try{
    		String myPath = myContext.getDatabasePath(DB_NAME).getAbsolutePath() ;//DB_PATH + DB_NAME;
...
//    	String outFileName = DB_PATH + DB_NAME;
	...
	public void onCreate(SQLiteDatabase db) {
		...
		try {
			...
			Log.e("dbhelper", "error creating db");
		}
	}
